...
public final class Focus<A, TA extends Traversable<A, ?>>
    implements Fn1<Zipper<A, TA>, Maybe<A>> {
  ...
  public static <A, TA extends Traversable<A, ?>> Maybe<A>
  focus(Zipper<A, TA> zipper) {
